...
我们设计了 AI 编程助手功能，基于 DeepSeek Coder 模型，用户设置 API 后，可对以下功能可视化：

1. **题目解析**：对当前题目进行算法思路和考点分析
2. **示例代码**：生成完整可运行的示例代码，包含详细注释
3. **代码调试**：分析用户代码中的问题并提供修复建议
4. **一般问答**：解答用户关于编程的各类问题
